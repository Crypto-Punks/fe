...
const AboutUsMenu = () => {
  ...
  return (
    <div className={`${styles.AboutUsMenu} ${openMenu ? styles.open : styles.closed}`} >
      ...
      <p>Check out all 1600 available coins to trade in Crypto Trades on the all coins page. Add to your watching list, click on a coin to get more details about each coin.</p>
