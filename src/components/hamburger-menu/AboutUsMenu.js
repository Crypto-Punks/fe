...
const AboutUsMenu = () => {
  ...
  return (
    <div className={`${styles.AboutUsMenu} ${openMenu ? styles.open : styles.closed}`} >
      ...
      <p>Crypto Trader was conceived as a way to practice trading in crypto currencies, using real time statics with fake money!</p>
      <p>Upon sign up, you will be given $100,000 to play with! ...how kind of us.</p>
      <p>On your portfolio page, check out how all of your current assets are doing</p>
      <p>Check out all the available coins to trade in on the all coins page. Add to your watching list, click on a coin to get more details about each coin.</p>
      ...
      <Link to='/about'>
        Check out the creators of Crypto Trader!
      </Link>
    </div >
  );
};
